    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            <div className="footer-logo">
              <svg className="footer-logo-svg" viewBox="0 0 200 49" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="footer-bottom">
          ...
          <p>onenight.com, All models confirm that they are 18 years old.</p>
        </div>
      </div>
    </footer>
  )
